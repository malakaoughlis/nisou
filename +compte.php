  ...
  <h5 align="center"><strong>Pour avoir des renseignements sur les composants d'une eau precise, il vous suffit d'entrer son nom !</strong></h5>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <?php
          //recuperer le mail de l'utilisateur pour avoir son nom et prenom 
         ...
         echo "<h2>Bienvenue " . $nom_u . " " . $prenom_u . " !</h2>";
          }
         else {
        ...
        ?>
          ...
          <style>
            ...
            <form action="bdd.php" method="POST">
              <label for="eleve"> <b>Vous cherchez une eau avec un composant élevé spécifique ? Il vous suffit de l'entrer pour que nous effectuions la recherche pour vous trouver la meilleure correspondance.</b></label>
            ...
            <br>
           <button type="submite" value="Chercher " name="recherche+" > Chercher </button>
          </form>
          
              <br><br><br><br>
              <form action="bdd.php" method="POST">
                <label for="faible"><b> Vous cherchez une eau avec un composant spécifique à faible niveau ? Il vous suffit de l'entrer pour que nous effectuions la recherche pour vous trouver la meilleure correspondance.</b></label>
                <select name="choix-" id="choix-">
                  <option value="Potassium">Potassium</option>
                  <option value="Calcium">Calcium</option>
                  <option value="Magnesium">Magnesium</option>
           ...
           <button type="submite" value="Chercher " name="recherche-" > Chercher </button>
              ...
              <form action="login.php" method="POST">
                <label ><b>DECONNEXION</b></label> <br>
